...
class TransmitterController extends AbstractController {
    ...
    private static final Set<String> VALID_KEYS_UPDATE = Set.of(
                                                                "usage", "timeslots", "power", "owners", "groups", "coordinates",
                                                                "aprs_broadcast", "enabled", "auth_key", "antenna", "type", "gain",
                                                                "direction", "agl"
                                                                );

    private static final String[] REQUIRED_KEYS_CREATE = {
        "_id", "usage", "timeslots", "power", "owners", "groups", "coordinates",
        "aprs_broadcast", "enabled", "auth_key", "antenna", "type", "gain",
        "direction", "agl"
    };
    ...
    private ResponseEntity<JsonNode> createTransmitter(Authentication auth, JsonNode transmitter) {
        ...
        return restTemplate.exchange(paramPath, HttpMethod.PUT, request, JsonNode.class, modTransmitter.get("_id").asText());
    }
